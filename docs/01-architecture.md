...
| 4 | Dockerfile `COPY ./jwt-lib/ ../` regression — **FIXED** in commit `599107f` (`COPY ./jwt-lib/ /jwt-lib/`, base `rust:1.88-slim`) | Build verified with `docker build` on 2026-08-17 | project-analysis.md §7.2 |
